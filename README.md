...
| AI | Anthropic Claude (Sonnet) -- writes and runs its own read-only SQL (see [`docs/decisions/0016`](docs/decisions/0016-chat-queries-directly.md)) and can render its own answer as an SVG picture, not just prose |
